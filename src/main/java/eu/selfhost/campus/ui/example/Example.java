...
@Description(title = "Some Example Configuration",
        description = "You can edit some test value and see simple validation.")
public class Example implements IValidatable {
